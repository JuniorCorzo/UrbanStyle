...
public record ProductSummary(
        ...
        int quantity,
        @Min(value = 0, message = "Discount must be greater than or equal to zero", groups = {OnCreate.class, OnUpdate.class}) @Max(value = 100, message = "Discount must be less than or equal to 100", groups = {OnCreate.class, OnUpdate.class})
        byte discount
) {
}
