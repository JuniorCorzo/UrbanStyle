...
export const CreateProductScheme = z.object({
	...
	images: ImageScheme,
	categories: z.array(CategoriesSummaryScheme).min(1, 'Se requiere al menos una categoría'),
	attributes: z.array(AttributesScheme).min(1, 'Se requiere al menos un atributo'),
})
